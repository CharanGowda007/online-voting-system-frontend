...
import { submitVoterRegistration, resetVoterRegistrationState } from '../redux/voter-register.reducer';
import { fetchStates } from '../../admin/redux/masterState.reducer';
import { fetchPCs, clearPCs } from '../../admin/redux/masterPC.reducer';
import { fetchACs, clearACs } from '../../admin/redux/masterAC.reducer';
                ...
                >
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
                        ...
                        <Form.Item name="pcCode" label="Parliamentary Constituency" rules={[{ required: true, message: 'Select PC' }]}>
                            ...
                            >
                                {pcs.map(pc => (
                                    <Option key={pc.parliamentCode} value={pc.parliamentCode}>
